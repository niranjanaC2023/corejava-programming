...
public class Perfomance3_Retrieving_ArrayList_Vector_LinkedList {
...
//===vector list==========
	int size = v.size()-1;
	time1 = System.nanoTime();
	v.get(Integer.valueOf(size));
	time2 = System.nanoTime();
	System.out.println("v last object retrieving time : "+(time2-time1));
	
//====Array list=========
		size = al.size()-1;
		time1 = System.nanoTime();
		al.get(Integer.valueOf(size));
		time2 = System.nanoTime();
		System.out.println("al last object retrieving time : "+(time2-time1));
//====Linked list=========
		size = li.size()-1;
		time1 = System.nanoTime();
		li.get(Integer.valueOf(size));
		time2 = System.nanoTime();
		System.out.println("li last object retrieving time : "+(time2-time1));
	}
}